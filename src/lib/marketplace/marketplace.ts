...
export class Marketplace {
  ...
  public importData(data: RawHubspotDataSet, console?: ConsoleLogger) {
    ...
    const emailChecker = (kind: 'License' | 'Transaction') => (record: License | Transaction) => {
    ...
    const combinedLicenses = [...data.licensesWithDataInsights, ...data.licensesWithoutDataInsights];
