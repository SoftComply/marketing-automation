...
export abstract class PipedriveEntityManager<D extends Record<string, any>, E extends PipedriveEntity<D>> {
  ...
  protected get kind(): PipedriveEntityKind {
    return this.entityAdapter.kind;
  }
  ...
  public constructor(private typeMappings: Map<string, string>) {}
...
function mapObject<T extends Record<string, any>, K extends keyof T, O>(
  o: T,
  fn: (e: T[K]) => O
): { [K in keyof T]: O } {
